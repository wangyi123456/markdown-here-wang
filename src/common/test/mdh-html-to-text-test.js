...
describe('MdhHtmlToText', function() {
  ...
  describe('MdhHtmlToText (check-for-MD mode)', function() {
    ...
    it('should not choke on links', function() {
      ...
      var html = '<a href="https://markdown-here.com">MDH</a>';
      var target = 'MDH';
